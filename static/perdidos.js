window.addEventListener("load", function() {
    let json = [
        {"especie":"cachorro","imagem":"static/dog.jpg", "raca":"Vira-Lata", "cor":"Branco", "porte": "Grande",
            "desc":"Exige muito de ti e espera pouco dos outros. Assim, evitarás muitos aborrecimentos.", "local": "Santo André, UFABC"}, 

        {"especie":"cachorro","imagem":"static/dog.jpg", "raca":"Pastor Alemão", "cor":"Branco", "porte": "Grande",
        ...
        {"especie":"gato","imagem":"static/catfinal.png", "raca":"Persa", "cor":"Branco", "porte": "Grande",
        ...
        {"especie":"gato","imagem":"static/catfinal.png", "raca":"Siamês", "cor":"Azul", "porte": "Grande",
    ...
    function adicionarMarkers() {
        if (map == null) {
            setTimeout(adicionarMarkers, 1000);
            return;
        }
